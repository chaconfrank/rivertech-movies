...
db.movies.insertMany([
        ...
        },
        {
            ...
            'key': 'the-tournament',
            'name': 'The Tournament',
            'description': 'Every seven years in an unsuspecting town, The Tournament takes place. A battle royale between 30 of the worlds deadliest assassins. The last man standing receiving the $10,            000,            000 cash prize and the title of Worlds No 1, which itself carries the legendary million dollar a bullet price tag.',
            'genres': [
                'action',
                'thriller'
            ],
